...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); //*(乘法)運算會很貼心的轉換型別所以是 3*8 = 24 > 21 ，因此 true
...
else if ((100000 < coachIncome) && (coachIncome <= 300000)){
...
const gymCoach = {
  "王教練":{
    ...
    "背景介紹":"擁有 5 年教學經驗，專精於提升學員的肌力與減脂，適合希望快速達成體能目標的學員。",
    "是否接收新學員": true
  },
  "李教練":{
    "專長": "瑜伽、體態雕塑",
    ...
    "背景介紹":"瑜伽大師，擁有 10 年教學經驗，擅長幫助學員雕塑完美體態，適合希望改善姿態與柔軟度的學員。",
    "是否接收新學員": false
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += activities["騎腳踏車"]["消耗的卡路里"] * 10;
calorieBurn += activities["跑步機"]["消耗的卡路里"] * 30;
calorieBurn += activities["瑜伽"]["消耗的卡路里"] * 40;
calorieBurn += activities["騎腳踏車"]["消耗的卡路里"] * 10;
...
if (exerciseRecords[3].duration >= 30 && exerciseRecords[3].heartRate >= 130) {
  let fridayDuration = exerciseRecords[3].duration;
  totalDuration += fridayDuration;
  validDays += 1;
}

if (exerciseRecords[4].duration >= 30 && exerciseRecords[4].heartRate >= 130) {
  let saturdayDuration = exerciseRecords[4].duration;
